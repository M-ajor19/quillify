      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-[#A1A1AA]">
            Your adaptive brand voice engine is ready. Let's create something extraordinary.
          </p>
        </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[#A1A1AA] mb-6">
                    Transform your raw content into polished, branded pieces. Your adaptive engine is ready.
                  </p>
                  <button
