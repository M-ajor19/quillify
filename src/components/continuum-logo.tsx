  ...
  return (
    ...
    >
      ...
      <g filter="url(#continuum-shadow)">
        ...
        <path d="M85 180 C75 150, 85 110, 100 45 C95 110, 90 140, 85 180 Z" fill="url(#continuum-purple-gradient)" />
        {/* Tip detail */}
        ...
        {/* Accent dot */}
        <circle cx="150" cy="40" r="7" fill="url(#continuum-dot-gradient)" />
      </g>
    </svg>
  );
};
